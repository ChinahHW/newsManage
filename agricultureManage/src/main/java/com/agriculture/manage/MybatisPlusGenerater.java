...
public class MybatisPlusGenerater {
     ...
     * 包名
     */
    private static final String PACKAGE_NAME = "com.agriculture.manage";
    /**
     * 模块名称
     */
     ...
     * 输出文件的路径
     */
    private static final String OUT_PATH = "G:\\IdeaWorkSpace\\agricultureManage";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "huwei";

    /**
     * JDBC相关配置
     */
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/agricultureManage?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
                            ...
                            public void initMap() {
                                ...
                                Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mapper.xml.vm") {
                                    ...
                                    public String outputFile(TableInfo tableInfo) {
                                        return OUT_PATH + "/mappers/" + tableInfo.getEntityName() + "Mapper.xml";
                                    }
                                })))
                .setTemplate(
